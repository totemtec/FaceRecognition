...
public class RgbSplit extends PipelineStage {
     ...
     * @throws Error if push() hasn't been called yet
     */
    public RgbImage getRandomizedRgbImage() throws Error {
        if (this.vecROk == null) {
            throw new Error(
                            Error.PACKAGE.CORE,
     ...
     * @throws Error if push() hasn't been called yet
     */
    public Enumeration getRegions() throws Error {
        if (this.vecROk == null) {
            throw new Error(
                            Error.PACKAGE.CORE,
                            jjil.core.ErrorCodes.NO_RESULT_AVAILABLE,
     ...
     * @throws Error if push() hasn't been called yet
     */
    public RgbImage getRgbImage() throws Error {
        if (this.vecROk == null) {
            throw new Error(
                            Error.PACKAGE.CORE,
                            jjil.core.ErrorCodes.NO_RESULT_AVAILABLE,
