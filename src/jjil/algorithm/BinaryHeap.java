...
public class BinaryHeap implements PriorityQueue {
	...
	public static class ComparableInt implements ComparableJ2me {
		...
		public ComparableInt(int n) {
			this.n = n;
                 ...
                 * @throws Error if o is not a ComparableInt
                 */
		public int compareTo(Object o) throws Error {
     ...
     * @throws Error if one of the objects compareTo method throws
     * jjil.core.Error.
     */
     ...
     * @throws Error if one of the objects in the priority queue throws jjil.core.Error when the
     * compareTo method is called.
     */
    public Position insert( ComparableJ2me x ) throws Error {
...
*/    
     ...
     * compareTo method is called.
     */
    public ComparableJ2me findMin() throws Error {
        if( isEmpty( ) )
            throw new Error(
                			Error.PACKAGE.ALGORITHM,
     ...
     * compareTo method is called.
     */
    public ComparableJ2me deleteMin() throws Error {
     ...
     */
    private void buildHeap( ) throws Error {
     ...
     */
    private void percolateDown( int hole ) throws Error {
        int child;
