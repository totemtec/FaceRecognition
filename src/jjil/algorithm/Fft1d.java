...
public class Fft1d {
     ...
     * @throws Error if width parameter is not a power of two.
     */
     ...
     * @throws Error if image size is not a power of two or is larger than maximum width set in
     * the constructor.
     */
    ...
    private Complex[] fft(Complex[] x, int nLog) throws Error {
        int N = x.length;
     ...
     * @throws Error if the input size is not a power of two or is larger than the maximum
     * set in the constructor.
     */
    public Complex[] ifft(Complex[] x) throws Error {
        int N = x.length;
        Complex[] y = new Complex[N];
     ...
     * @throws Error If N is not a power of 2.
     */
    public void setMaxWidth(int N) throws Error {
        if ((N & (N-1)) != 0) {
            throw new Error(
            			Error.PACKAGE.ALGORITHM,
            			ErrorCodes.FFT_SIZE_NOT_POWER_OF_2,
