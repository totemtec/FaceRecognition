...
/**
 * Computes the vertical Canny operator for an input gray image. The sigma
...
public class Gray8CannyVert extends PipelineStage {
     ...
     * @throws Error if cSigma is out of range.
     */
    public Gray8CannyVert(int cSigma) throws Error {
            ...
            for (int i=0; i<input.getHeight(); i++) {
                ...
                for (int k=0; 
                    ...
                    if (i + k < input.getHeight()) {
                        ...
                        int cPos = 2*input.getHeight() - (i + k + 1);
