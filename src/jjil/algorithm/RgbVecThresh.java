...
public class RgbVecThresh extends PipelineStage {
     ...
     * @throws Error if input is not an RgbImage.
     */
    public void push(Image imageInput) throws Error {
        ...
        byte[] bData = new byte[rgb.getWidth()*rgb.getHeight()];
        int targets=0;
...
//                    ? Byte.MAX_VALUE : Byte.MIN_VALUE;
        ...
        super.setOutput(new Gray8Image(rgb.getWidth(), rgb.getHeight(),bData));
        //System.out.println("Got: "+targets+" target pixles");
    }
